...
<main>
  ...
  <section class="kpis" id="kpiSection">
    <div class="kpi kpi-link" data-tab-jump="detail"><div class="kpi-label">?? ????</div><div class="kpi-value blue" id="kpiQty">-</div><div class="kpi-note">?? 7? ? ??? ??</div><div class="kpi-bar"><div id="kpiQtyBar" style="width:75%;background:var(--blue)"></div></div></div>
    <div class="kpi kpi-link" data-tab-jump="calendar"><div class="kpi-label">?? ?????</div><div class="kpi-value" id="kpiPayment">-</div><div class="kpi-note">?? 7? ???? ??</div><div class="kpi-bar"><div id="kpiPaymentBar" style="width:58%;background:#6366f1"></div></div></div>
  ...
  <div id="overview" class="tab-panel active">
    ...
    <div class="panel panel-link" data-tab-jump="retailer" style="margin-bottom:12px">
      <div class="panel-hd"><span class="panel-title">?? 3? ???? ??</span><span class="panel-meta">?? 3?</span></div>
